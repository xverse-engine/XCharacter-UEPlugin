...
DECLARE_MULTICAST_DELEGATE_ThreeParams(FOnAudioImporterResultNative, URuntimeAudioImporterLibrary*, UImportedSoundWave*,
                                       ERuntimeImportStatus);

/** Dynamic delegate broadcasting the audio importer result */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnAudioImporterResult, URuntimeAudioImporterLibrary*, Importer,
...
DECLARE_DYNAMIC_DELEGATE_TwoParams(FOnRegularToAudioImporterSoundWaveConvertResult, bool, bSucceeded,
...
public:
	...
	UFUNCTION(BlueprintCallable,
		meta = (Keywords = "Importer, Transcoder, Converter, Runtime, MP3, FLAC, WAV, OGG, Vorbis"),
	 ...
	 */
	UFUNCTION(BlueprintCallable,
		meta = (Keywords = "Importer, Transcoder, Converter, Runtime, MP3, FLAC, WAV, OGG, Vorbis, BINK"),
		Category = "Runtime Audio Importer|Import")
	...
	UFUNCTION(BlueprintCallable,
		meta = (Keywords = "Importer, Transcoder, Converter, Runtime, MP3, FLAC, WAV, OGG, Vorbis, BINK"),
		Category = "Runtime Audio Importer|Import")
	UImportedSoundWave* ImportAudioFromBufferWithReturn(TArray<uint8> AudioData, ERuntimeAudioFormat AudioFormat);
    ...
    * @param AudioFormat Audio format
    */
	UImportedSoundWave* ImportAudioWithReturn(TArray64<uint8> AudioData, ERuntimeAudioFormat AudioFormat);
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Import Audio From RAW File", Keywords = "PCM, RAW"),
		Category = "Runtime Audio Importer|Import")
	void ImportAudioFromRAWFile(const FString& FilePath,
	                            UPARAM(DisplayName = "RAW Format") ERuntimeRAWAudioFormat RAWFormat,
	                            int32 SampleRate = 44100, int32 NumOfChannels = 1);
	 ...
	 * @param NumOfChannels The number of channels (1 for mono, 2 for stereo, etc)
	 */
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Import Audio From RAW Buffer", Keywords = "PCM, RAW"),
		Category = "Runtime Audio Importer|Import")
	void ImportAudioFromRAWBuffer(UPARAM(DisplayName = "RAW Buffer") TArray<uint8> RAWBuffer,
	                              UPARAM(DisplayName = "RAW Format") ERuntimeRAWAudioFormat RAWFormat,
	                              int32 SampleRate = 44100, int32 NumOfChannels = 1);
	 ...
	 * @param NumOfChannels The number of channels (1 for mono, 2 for stereo, etc)
	 */
	void ImportAudioFromRAWBuffer(TArray64<uint8> RAWBuffer, ERuntimeRAWAudioFormat RAWFormat, int32 SampleRate = 44100,
	                              int32 NumOfChannels = 1);
	...
	static void ConvertRegularToImportedSoundWave(USoundWave* SoundWave,
	                                              TSubclassOf<UImportedSoundWave> ImportedSoundWaveClass,
	                                              const FOnRegularToAudioImporterSoundWaveConvertResult& Result);
	...
	static void ConvertRegularToImportedSoundWave(USoundWave* SoundWave,
	                                              TSubclassOf<UImportedSoundWave> ImportedSoundWaveClass,
	                                              const FOnRegularToAudioImporterSoundWaveConvertResultNative& Result);
	...
	/**
 	 ...
 	 * @param SoundWave The regular USoundWave to convert
 	 */
	static UImportedSoundWave* ConvertRegularToImportedSoundWave(USoundWave* SoundWave);
	 ...
	 */
	static bool EncodeAudioData(FDecodedAudioStruct&& DecodedAudioInfo, FEncodedAudioStruct& EncodedAudioInfo,
	                            uint8 Quality);
	 ...
	 * @param NumOfChannels The number of channels (1 for mono, 2 for stereo, etc)
	 */
	void ImportAudioFromFloat32Buffer(FRuntimeBulkDataBuffer<float>&& PCMData, int32 SampleRate = 44100,
	                                  int32 NumOfChannels = 1);
	 ...
	 */
	static bool ResampleAndMixChannelsInDecodedInfo(FDecodedAudioStruct& DecodedAudioInfo, uint32 NewSampleRate,
	                                                uint32 NewNumOfChannels);
