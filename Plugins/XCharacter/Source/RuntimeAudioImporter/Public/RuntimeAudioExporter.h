...
public:
	...
	static void ExportSoundWaveToFile(UImportedSoundWave* ImportedSoundWave, const FString& SavePath,
	 ...
	 * @param Result Delegate broadcasting the result
	 */
	static void ExportSoundWaveToFile(TWeakObjectPtr<UImportedSoundWave> ImportedSoundWavePtr, const FString& SavePath,
	                                  ERuntimeAudioFormat AudioFormat, uint8 Quality,
	                                  const FRuntimeAudioExportOverrideOptions& OverrideOptions,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Runtime Audio Exporter")
	static void ExportSoundWaveToBuffer(UImportedSoundWave* ImportedSoundWave, ERuntimeAudioFormat AudioFormat,
	                                    uint8 Quality, const FRuntimeAudioExportOverrideOptions& OverrideOptions,
	 ...
	 * @param Result Delegate broadcasting the result
	 */
	static void ExportSoundWaveToBuffer(TWeakObjectPtr<UImportedSoundWave> ImportedSoundWavePtr,
	                                    ERuntimeAudioFormat AudioFormat, uint8 Quality,
	                                    const FRuntimeAudioExportOverrideOptions& OverrideOptions,
	 ...
	 * @param Result Delegate broadcasting the result
	 */
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Export Sound Wave To RAW File"),
		Category = "Runtime Audio Exporter")
	static void ExportSoundWaveToRAWFile(UImportedSoundWave* ImportedSoundWave, const FString& SavePath,
	 ...
	 * @param Result Delegate broadcasting the result
	 */
	static void ExportSoundWaveToRAWFile(TWeakObjectPtr<UImportedSoundWave> ImportedSoundWavePtr,
	 ...
	 * @param Result Delegate broadcasting the result
	 */
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Export Sound Wave To RAW Buffer"),
		Category = "Runtime Audio Exporter")
	static void ExportSoundWaveToRAWBuffer(UImportedSoundWave* ImportedSoundWave,
	                                       UPARAM(DisplayName = "RAW Format") ERuntimeRAWAudioFormat RAWFormat,
	                                       const FRuntimeAudioExportOverrideOptions& OverrideOptions,
	                                       const FOnAudioExportToBufferResult& Result);
	 ...
	 * @param Result Delegate broadcasting the result
	 */
	static void ExportSoundWaveToRAWBuffer(TWeakObjectPtr<UImportedSoundWave> ImportedSoundWavePtr,
	...
	/**
 	 ...
 	 * @param RAWFormat Required RAW format for exporting
 	 */
	static TArray<uint8> ExportSoundWaveToRAWBuffer(TWeakObjectPtr<UImportedSoundWave> ImportedSoundWavePtr,
	                                                ERuntimeRAWAudioFormat RAWFormat,
	                                                 const FRuntimeAudioExportOverrideOptions& OverrideOptions);
};
