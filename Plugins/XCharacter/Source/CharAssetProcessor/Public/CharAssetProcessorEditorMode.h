...
#include "CharAssetProcessorEditorMode.generated.h"
 ...
 */
UCLASS()
class UCharAssetProcessorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_CharAssetProcessorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UCharAssetProcessorEditorMode();
	virtual ~UCharAssetProcessorEditorMode();
