...
#include "CharAssetProcessorInteractiveTool.generated.h"


/**
 * Builder for UCharAssetProcessorInteractiveTool
 */
UCLASS()
class CHARASSETPROCESSOR_API UCharAssetProcessorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UCharAssetProcessorInteractiveTool
 */
UCLASS(Transient)
class CHARASSETPROCESSOR_API UCharAssetProcessorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UCharAssetProcessorInteractiveToolProperties();
...
/**
 * UCharAssetProcessorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class CHARASSETPROCESSOR_API UCharAssetProcessorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UCharAssetProcessorInteractiveToolProperties> Properties;
