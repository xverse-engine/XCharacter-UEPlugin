...
#include "CharAssetProcessorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UCharAssetProcessorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UCharAssetProcessorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UCharAssetProcessorInteractiveTool* NewTool = NewObject<UCharAssetProcessorInteractiveTool>(SceneState.ToolManager);
...
UCharAssetProcessorInteractiveToolProperties::UCharAssetProcessorInteractiveToolProperties()
{
...
void UCharAssetProcessorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UCharAssetProcessorInteractiveTool::Setup()
{
	...
	Properties = NewObject<UCharAssetProcessorInteractiveToolProperties>(this, "Measurement");
...
void UCharAssetProcessorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UCharAssetProcessorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UCharAssetProcessorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UCharAssetProcessorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UCharAssetProcessorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UCharAssetProcessorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UCharAssetProcessorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UCharAssetProcessorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UCharAssetProcessorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
